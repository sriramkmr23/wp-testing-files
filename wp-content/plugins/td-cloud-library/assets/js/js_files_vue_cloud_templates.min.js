...
a.templatesCardDataView=a.templatesCardData.tpl_card_data_assets.card_tpl_data_view_link;a.templateType=this.template_type;a.setTemplateNameEditDisplay();a.customTemplateType=this.custom_template_type;eventHub.$on("refresh-cpt",a.refreshCpt);eventHub.$on("refresh-cpt-tax",a.refreshCptTax);var b="";b=a.templateType.startsWith("pa_")||"woo_archive_tag"===a.templateType||"woo_archive_attribute"===a.templateType?"tdb_ct_tpl_card_data_update_woo_archive":"tdb_ct_tpl_card_data_update_"+a.templateType;jQuery("body").on(b,
function(b,d){a.getTemplateCardData()})},methods:{getTemplateCardData:function(a){var b=this;b.loading=!0;b.errors=[];jQuery.ajax({url:td_ajax_url,type:"post",data:{action:"tdb_ct_get_tpl_card_data",_nonce:window.tdb_globals.wpRestNonce,tpl_type:b.templateType},success:function(c){c=JSON.parse(c);"undefined"!==typeof c.templates?(b.templatesCardData=c,b.templatesCardDataId=c.tpl_card_data_assets.card_tpl_data_id,b.templatesCardDataView=c.tpl_card_data_assets.card_tpl_data_view_link,"undefined"!==
typeof a&&"undefined"!==typeof a.callback&&a.callback()):b.errors.push({type:c.type,message:"tpl card data update error: "+c.msg});b.loading=!1},error:function(b,a,e){console.log("%c"+e,"color: #dc2121c7")}})},cloudLibraryImportMobile:function(a){var b="page"===this.templateType||"homepage"===this.templateType?"page":this.templateType;a={wp_type:b,force_parent_template_type:b,hide_mobile_selector:"hide",install_template_route:"addRoute",assign_mobile_to_template:a.toString()};switch(this.templateType){case "page":a.templateType=
"Pages";break;case "homepage":a.templateType="Homepages"}window.tdbVue.router.push({name:"loadRoute",params:a})},getTdcEditLink:function(a){var b=window.tdb_globals.wpAdminUrl,c=encodeURIComponent(window.location);switch(this.templateType){case "page":case "homepage":var d="page";break;case "woo_archive_attribute":case "woo_archive_tag":d="woo_archive";break;default:d=this.templateType.startsWith("pa_")?"woo_archive":this.templateType}return this.templatesCardDataId?b+"post.php?post_id="+a.ID+"&td_action=tdc&tdbLoadDataFromId="+
this.templatesCardDataId+"&tdbTemplateType="+d+"&prev_url="+c:b+"post.php?post_id="+a.ID+"&td_action=tdc&tdbTemplateType="+d+"&prev_url="+c},isGlobalTpl:function(a,b){if("undefined"!==typeof a.global_tpls){a=$jscomp.makeIterator(Object.entries(a.global_tpls));for(var c=a.next();!c.done;c=a.next()){var d=$jscomp.makeIterator(c.value);c=d.next().value;d=d.next().value;if(c===this.customTemplateType&&d===b)return!0}}else if("undefined"!==typeof a.global_tpl&&a.global_tpl===b)return!0;return!1},setGlobalTpl:function(a,
b){var c=this;c.loading=!0;c.errors=[];a={_nonce:window.tdb_globals.wpRestNonce,template_id:a,template_type:c.templateType};"undefined"!==typeof b&&!0===b&&(a.unset=!0);switch(c.templateType){case "single":case "header":case "footer":case "404":case "attachment":case "author":case "date":case "tag":case "search":case "woo_product":case "woo_shop_base":case "woo_search_archive":case "homepage":a.action="tdb_assign_"+c.templateType+"_template_global";break;case "cpt":a.cpt=c.customTemplateType;a.action=
